...
@NamedQueries({
    ...
    @NamedQuery(name = "Docent.docentenInTweeCampussen", query = "SELECT d FROM Docent d WHERE :campusA MEMEBER OF d.campussen AND :campusB MEMEBER OF d.campussen")
})
@Table(name = "docenten")
public class Docent implements Serializable {
    ...
    protected Docent() { // nodig voor JPA-ORM tool
